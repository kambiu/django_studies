...
urlpatterns = [
    ...
    url(r'^group/editview/(?P<pk>[0-9]+)/$', views.GroupUpdate.as_view(), name='group-update'),
    url(r'^group/deleteview/(?P<pk>[0-9]+)/$', views.GroupDelete.as_view(), name='group-delete'),
    url(r'^group/del/$', views.group_delete, name='group-del'),
    url(r'^group/edit/(?P<group_id>[0-9]+)/$', views.group_edit, name='group-edit'),
    url(r'^group/data/$', views.group_data, name='group-data'),
